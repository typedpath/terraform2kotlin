...
class Ingress(val from_port : Int, val action : String, val to_port : Int, val rule_no : Int, val protocol : String) :  com.typedpath.terraform2kotlin.Resource() {
...
class Egress(val rule_no : Int, val action : String, val from_port : Int, val to_port : Int, val protocol : String) :  com.typedpath.terraform2kotlin.Resource() {
	override fun typestring() ="subresource"
	  var ipv6_cidr_block: String? = null
  var icmp_type: Int? = null
  var icmp_code: Int? = null
