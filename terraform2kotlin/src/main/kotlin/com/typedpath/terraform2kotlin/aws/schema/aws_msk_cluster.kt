...
class aws_msk_cluster(val number_of_broker_nodes : Int, val broker_node_group_info : List<Broker_node_group_info>, val kafka_version : String, val cluster_name : String) :  com.typedpath.terraform2kotlin.Resource() {
...
class Broker_node_group_info(val security_groups : List<String>, val ebs_volume_size : Int, val client_subnets : List<String>, val instance_type : String) :  com.typedpath.terraform2kotlin.Resource() {
