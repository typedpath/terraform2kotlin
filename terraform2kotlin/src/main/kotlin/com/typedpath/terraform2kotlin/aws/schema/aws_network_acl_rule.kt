...
class aws_network_acl_rule(val network_acl_id : String, val rule_number : Int, val protocol : String, val rule_action : String) :  com.typedpath.terraform2kotlin.Resource() {
