...
class aws_eks_node_group(val node_group_name : String, val cluster_name : String, val node_role_arn : String, val scaling_config : List<Scaling_config>, val subnet_ids : List<String>) :  com.typedpath.terraform2kotlin.Resource() {
