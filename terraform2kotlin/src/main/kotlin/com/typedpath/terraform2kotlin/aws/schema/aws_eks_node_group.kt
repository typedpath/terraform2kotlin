...
class aws_eks_node_group(val node_role_arn : String, val subnet_ids : List<String>, val node_group_name : String, val scaling_config : List<Scaling_config>, val cluster_name : String) :  com.typedpath.terraform2kotlin.Resource() {
