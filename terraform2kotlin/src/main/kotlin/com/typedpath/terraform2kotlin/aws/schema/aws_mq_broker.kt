...
class aws_mq_broker(val user : List<User>, val broker_name : String, val engine_type : String, val security_groups : List<String>, val engine_version : String, val host_instance_type : String) :  com.typedpath.terraform2kotlin.Resource() {
