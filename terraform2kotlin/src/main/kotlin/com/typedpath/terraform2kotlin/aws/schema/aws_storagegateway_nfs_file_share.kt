...
class aws_storagegateway_nfs_file_share(val location_arn : String, val role_arn : String, val gateway_arn : String, val client_list : List<String>) :  com.typedpath.terraform2kotlin.Resource() {
