...
class Byte_match_tuple(val text_transformation : String, val field_to_match : List<Field_to_match>, val positional_constraint : String) :  com.typedpath.terraform2kotlin.Resource() {
