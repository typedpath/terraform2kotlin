...
class aws_ec2_transit_gateway_vpc_attachment(val subnet_ids : List<String>, val transit_gateway_id : String, val vpc_id : String) :  com.typedpath.terraform2kotlin.Resource() {
