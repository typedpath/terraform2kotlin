...
class aws_opsworks_stack(val region : String, val name : String, val service_role_arn : String, val default_instance_profile_arn : String) :  com.typedpath.terraform2kotlin.Resource() {
