...
class aws_api_gateway_stage(val deployment_id : String, val stage_name : String, val rest_api_id : String) :  com.typedpath.terraform2kotlin.Resource() {
...
class Access_log_settings(val format : String, val destination_arn : String) :  com.typedpath.terraform2kotlin.Resource() {
