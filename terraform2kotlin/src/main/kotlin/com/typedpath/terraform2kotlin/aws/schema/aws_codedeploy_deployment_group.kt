...
class aws_codedeploy_deployment_group(val app_name : String, val deployment_group_name : String, val service_role_arn : String) :  com.typedpath.terraform2kotlin.Resource() {
...
class Trigger_configuration(val trigger_target_arn : String, val trigger_events : List<Trigger_events>, val trigger_name : String) :  com.typedpath.terraform2kotlin.Resource() {
	override fun typestring() ="subresource"
