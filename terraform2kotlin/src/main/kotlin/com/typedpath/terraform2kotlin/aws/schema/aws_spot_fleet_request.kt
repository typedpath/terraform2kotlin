...
class aws_spot_fleet_request(val iam_fleet_role : String, val target_capacity : Int, val launch_specification : List<Launch_specification>) :  com.typedpath.terraform2kotlin.Resource() {
