...
class aws_spot_fleet_request(val launch_specification : List<Launch_specification>, val iam_fleet_role : String, val target_capacity : Int) :  com.typedpath.terraform2kotlin.Resource() {
