...
class aws_dlm_lifecycle_policy(val policy_details : List<Policy_details>, val description : String, val execution_role_arn : String) :  com.typedpath.terraform2kotlin.Resource() {
