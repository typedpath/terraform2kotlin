...
class Policy_details(val target_tags : Map<String, String>, val resource_types : List<String>, val schedule : List<Schedule>) :  com.typedpath.terraform2kotlin.Resource() {
