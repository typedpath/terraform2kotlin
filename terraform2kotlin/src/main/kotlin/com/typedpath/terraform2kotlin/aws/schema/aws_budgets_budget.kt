...
class aws_budgets_budget(val time_unit : String, val budget_type : String, val limit_amount : String, val limit_unit : String, val time_period_start : String) :  com.typedpath.terraform2kotlin.Resource() {
