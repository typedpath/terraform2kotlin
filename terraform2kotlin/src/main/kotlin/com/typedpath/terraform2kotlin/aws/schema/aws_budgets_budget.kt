...
class Notification(val threshold : Float, val threshold_type : Threshold_type, val notification_type : Notification_type, val comparison_operator : Comparison_operator) :  com.typedpath.terraform2kotlin.Resource() {
	override fun typestring() ="subresource"
