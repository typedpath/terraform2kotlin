...
class aws_ec2_capacity_reservation(val instance_platform : Instance_platform, val instance_count : Int, val instance_type : String, val availability_zone : String) :  com.typedpath.terraform2kotlin.Resource() {
