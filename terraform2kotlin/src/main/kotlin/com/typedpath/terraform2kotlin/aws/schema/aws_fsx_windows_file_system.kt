...
class aws_fsx_windows_file_system(val storage_capacity : Int, val subnet_ids : List<String>, val throughput_capacity : Int) :  com.typedpath.terraform2kotlin.Resource() {
