...
class Compute_resources(val instance_type : List<String>, val subnets : List<String>, val instance_role : String, val max_vcpus : Int, val min_vcpus : Int, val security_group_ids : List<String>, val type : Type) :  com.typedpath.terraform2kotlin.Resource() {
