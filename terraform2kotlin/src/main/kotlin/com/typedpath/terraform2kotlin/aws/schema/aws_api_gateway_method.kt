...
class aws_api_gateway_method(val resource_id : String, val http_method : Http_method, val authorization : String, val rest_api_id : String) :  com.typedpath.terraform2kotlin.Resource() {
