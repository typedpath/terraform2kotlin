...
class aws_api_gateway_method(val http_method : Http_method, val rest_api_id : String, val resource_id : String, val authorization : String) :  com.typedpath.terraform2kotlin.Resource() {
