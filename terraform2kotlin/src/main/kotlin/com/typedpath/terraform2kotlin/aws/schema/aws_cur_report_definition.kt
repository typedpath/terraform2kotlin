...
class aws_cur_report_definition(val time_unit : Time_unit, val compression : Compression, val additional_schema_elements : List<Additional_schema_elements>, val s3_bucket : String, val s3_region : String, val report_name : String, val format : Format) :  com.typedpath.terraform2kotlin.Resource() {
