...
class aws_cur_report_definition(val report_name : String, val compression : Compression, val s3_region : String, val time_unit : Time_unit, val format : Format, val additional_schema_elements : List<Additional_schema_elements>, val s3_bucket : String) :  com.typedpath.terraform2kotlin.Resource() {
