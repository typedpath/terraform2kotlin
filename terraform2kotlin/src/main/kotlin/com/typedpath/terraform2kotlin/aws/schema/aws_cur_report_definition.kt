...
class aws_cur_report_definition(val s3_region : String, val time_unit : Time_unit, val format : Format, val additional_schema_elements : List<Additional_schema_elements>, val s3_bucket : String, val report_name : String, val compression : Compression) :  com.typedpath.terraform2kotlin.Resource() {
