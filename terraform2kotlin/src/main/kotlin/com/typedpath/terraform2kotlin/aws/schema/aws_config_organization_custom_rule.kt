...
class aws_config_organization_custom_rule(val trigger_types : List<Trigger_types>, val lambda_function_arn : String, val name : String) :  com.typedpath.terraform2kotlin.Resource() {
