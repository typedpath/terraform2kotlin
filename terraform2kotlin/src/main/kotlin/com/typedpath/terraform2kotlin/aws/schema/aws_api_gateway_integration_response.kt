...
class aws_api_gateway_integration_response(val rest_api_id : String, val http_method : Http_method, val status_code : String, val resource_id : String) :  com.typedpath.terraform2kotlin.Resource() {
