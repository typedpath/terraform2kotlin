...
class Authenticate_oidc(val authorization_endpoint : String, val user_info_endpoint : String, val client_secret : String, val issuer : String, val token_endpoint : String, val client_id : String) :  com.typedpath.terraform2kotlin.Resource() {
	override fun typestring() ="subresource"
