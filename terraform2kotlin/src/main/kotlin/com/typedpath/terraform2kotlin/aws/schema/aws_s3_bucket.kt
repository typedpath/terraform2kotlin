...
class Replication_configuration(val rules : List<Rules>, val role : String) :  com.typedpath.terraform2kotlin.Resource() {
	override fun typestring() ="subresource"
...
class Cors_rule(val allowed_origins : List<String>, val allowed_methods : List<String>) :  com.typedpath.terraform2kotlin.Resource() {
	override fun typestring() ="subresource"
