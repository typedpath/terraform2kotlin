...
class Redshift_configuration(val password : String, val data_table_name : String, val cluster_jdbcurl : String, val username : String, val role_arn : String) :  com.typedpath.terraform2kotlin.Resource() {
	override fun typestring() ="subresource"
	  var cloudwatch_logging_options: List<Cloudwatch_logging_options>? = null
  var s3_backup_mode: String? = null
  var s3_backup_configuration: List<S3_backup_configuration>? = null
...
class Elasticsearch_configuration(val index_name : String, val domain_arn : String, val role_arn : String) :  com.typedpath.terraform2kotlin.Resource() {
	override fun typestring() ="subresource"
	  var s3_backup_mode: String? = null
