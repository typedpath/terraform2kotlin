...
class Parameters(val parameter_value : String, val parameter_name : String) :  com.typedpath.terraform2kotlin.Resource() {
	override fun typestring() ="subresource"
...
class Schema_configuration(val role_arn : String, val table_name : String, val database_name : String) :  com.typedpath.terraform2kotlin.Resource() {
	override fun typestring() ="subresource"
	  var version_id: String? = null
...
class Redshift_configuration(val role_arn : String, val data_table_name : String, val cluster_jdbcurl : String, val username : String, val password : String) :  com.typedpath.terraform2kotlin.Resource() {
	override fun typestring() ="subresource"
	  var s3_backup_configuration: List<S3_backup_configuration>? = null
  var retry_duration: Int? = null
...
class S3_backup_configuration(val bucket_arn : String, val role_arn : String) :  com.typedpath.terraform2kotlin.Resource() {
	override fun typestring() ="subresource"
	  var compression_format: String? = null
  var kms_key_arn: String? = null
  var prefix: String? = null
...
class Elasticsearch_configuration(val index_name : String, val role_arn : String, val domain_arn : String) :  com.typedpath.terraform2kotlin.Resource() {
	override fun typestring() ="subresource"
