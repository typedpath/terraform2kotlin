...
class Redshift_configuration(val cluster_jdbcurl : String, val username : String, val role_arn : String, val data_table_name : String, val password : String) :  com.typedpath.terraform2kotlin.Resource() {
