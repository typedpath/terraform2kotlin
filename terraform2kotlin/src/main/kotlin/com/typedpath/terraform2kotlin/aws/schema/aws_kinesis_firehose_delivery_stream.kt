...
class Redshift_configuration(val password : String, val role_arn : String, val cluster_jdbcurl : String, val username : String, val data_table_name : String) :  com.typedpath.terraform2kotlin.Resource() {
	override fun typestring() ="subresource"
	  var retry_duration: Int? = null
