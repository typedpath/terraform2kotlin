...
class aws_codebuild_project(val source : List<Source>, val artifacts : List<Artifacts>, val service_role : String, val name : String, val environment : List<Environment>) :  com.typedpath.terraform2kotlin.Resource() {
...
class Secondary_artifacts(val artifact_identifier : String, val type : Type) :  com.typedpath.terraform2kotlin.Resource() {
	override fun typestring() ="subresource"
	  var encryption_disabled: Boolean? = null
  var override_artifact_name: Boolean? = null
  var path: String? = null
...
class Vpc_config(val security_group_ids : List<String>, val vpc_id : String, val subnets : List<String>) :  com.typedpath.terraform2kotlin.Resource() {
	override fun typestring() ="subresource"
