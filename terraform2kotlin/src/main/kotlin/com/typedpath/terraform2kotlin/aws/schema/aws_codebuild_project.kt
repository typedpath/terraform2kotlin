...
class aws_codebuild_project(val name : String, val source : List<Source>, val service_role : String, val artifacts : List<Artifacts>, val environment : List<Environment>) :  com.typedpath.terraform2kotlin.Resource() {
