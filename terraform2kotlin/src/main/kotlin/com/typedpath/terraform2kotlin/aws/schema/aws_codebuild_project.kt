...
class aws_codebuild_project(val artifacts : List<Artifacts>, val environment : List<Environment>, val source : List<Source>, val name : String, val service_role : String) :  com.typedpath.terraform2kotlin.Resource() {
