...
class aws_cloudfront_distribution(val default_cache_behavior : List<Default_cache_behavior>, val viewer_certificate : List<Viewer_certificate>, val enabled : Boolean, val origin : List<Origin>, val restrictions : List<Restrictions>) :  com.typedpath.terraform2kotlin.Resource() {
...
class Default_cache_behavior(val target_origin_id : String, val viewer_protocol_policy : String, val allowed_methods : List<String>, val cached_methods : List<String>, val forwarded_values : List<Forwarded_values>) :  com.typedpath.terraform2kotlin.Resource() {
...
class Custom_header(val value : String, val name : String) :  com.typedpath.terraform2kotlin.Resource() {
	override fun typestring() ="subresource"
...
class Ordered_cache_behavior(val allowed_methods : List<String>, val cached_methods : List<String>, val forwarded_values : List<Forwarded_values>, val path_pattern : String, val target_origin_id : String, val viewer_protocol_policy : String) :  com.typedpath.terraform2kotlin.Resource() {
	override fun typestring() ="subresource"
	  var lambda_function_association: List<Lambda_function_association>? = null
  var default_ttl: Int? = null
  var field_level_encryption_id: String? = null
...
class Cache_behavior(val viewer_protocol_policy : String, val allowed_methods : List<String>, val path_pattern : String, val cached_methods : List<String>, val forwarded_values : List<Forwarded_values>, val target_origin_id : String) :  com.typedpath.terraform2kotlin.Resource() {
	override fun typestring() ="subresource"
	  var min_ttl: Int? = null
  var smooth_streaming: Boolean? = null
  var field_level_encryption_id: String? = null
