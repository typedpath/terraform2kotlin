...
class aws_cloudfront_distribution(val viewer_certificate : List<Viewer_certificate>, val default_cache_behavior : List<Default_cache_behavior>, val enabled : Boolean, val restrictions : List<Restrictions>, val origin : List<Origin>) :  com.typedpath.terraform2kotlin.Resource() {
...
class Default_cache_behavior(val allowed_methods : List<String>, val cached_methods : List<String>, val forwarded_values : List<Forwarded_values>, val target_origin_id : String, val viewer_protocol_policy : String) :  com.typedpath.terraform2kotlin.Resource() {
	override fun typestring() ="subresource"
...
class Custom_origin_config(val origin_protocol_policy : String, val origin_ssl_protocols : List<String>, val http_port : Int, val https_port : Int) :  com.typedpath.terraform2kotlin.Resource() {
	override fun typestring() ="subresource"
...
class Cache_behavior(val allowed_methods : List<String>, val path_pattern : String, val target_origin_id : String, val forwarded_values : List<Forwarded_values>, val viewer_protocol_policy : String, val cached_methods : List<String>) :  com.typedpath.terraform2kotlin.Resource() {
	override fun typestring() ="subresource"
	  var min_ttl: Int? = null
  var lambda_function_association: List<Lambda_function_association>? = null
  var trusted_signers: List<String>? = null
...
class Ordered_cache_behavior(val cached_methods : List<String>, val path_pattern : String, val allowed_methods : List<String>, val forwarded_values : List<Forwarded_values>, val target_origin_id : String, val viewer_protocol_policy : String) :  com.typedpath.terraform2kotlin.Resource() {
	override fun typestring() ="subresource"
	  var lambda_function_association: List<Lambda_function_association>? = null
  var max_ttl: Int? = null
  var min_ttl: Int? = null
