...
class aws_cloudfront_distribution(val restrictions : List<Restrictions>, val default_cache_behavior : List<Default_cache_behavior>, val enabled : Boolean, val origin : List<Origin>, val viewer_certificate : List<Viewer_certificate>) :  com.typedpath.terraform2kotlin.Resource() {
...
class Default_cache_behavior(val cached_methods : List<String>, val viewer_protocol_policy : String, val allowed_methods : List<String>, val forwarded_values : List<Forwarded_values>, val target_origin_id : String) :  com.typedpath.terraform2kotlin.Resource() {
...
class Ordered_cache_behavior(val forwarded_values : List<Forwarded_values>, val cached_methods : List<String>, val target_origin_id : String, val path_pattern : String, val viewer_protocol_policy : String, val allowed_methods : List<String>) :  com.typedpath.terraform2kotlin.Resource() {
	override fun typestring() ="subresource"
	  var smooth_streaming: Boolean? = null
  var field_level_encryption_id: String? = null
  var max_ttl: Int? = null
...
class Cache_behavior(val path_pattern : String, val target_origin_id : String, val viewer_protocol_policy : String, val allowed_methods : List<String>, val cached_methods : List<String>, val forwarded_values : List<Forwarded_values>) :  com.typedpath.terraform2kotlin.Resource() {
	override fun typestring() ="subresource"
	  var default_ttl: Int? = null
  var min_ttl: Int? = null
  var compress: Boolean? = null
