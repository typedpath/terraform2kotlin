...
class aws_cloudfront_distribution(val enabled : Boolean, val viewer_certificate : List<Viewer_certificate>, val restrictions : List<Restrictions>, val origin : List<Origin>, val default_cache_behavior : List<Default_cache_behavior>) :  com.typedpath.terraform2kotlin.Resource() {
...
class Default_cache_behavior(val allowed_methods : List<String>, val cached_methods : List<String>, val viewer_protocol_policy : String, val forwarded_values : List<Forwarded_values>, val target_origin_id : String) :  com.typedpath.terraform2kotlin.Resource() {
	override fun typestring() ="subresource"
...
class Ordered_cache_behavior(val target_origin_id : String, val cached_methods : List<String>, val path_pattern : String, val forwarded_values : List<Forwarded_values>, val viewer_protocol_policy : String, val allowed_methods : List<String>) :  com.typedpath.terraform2kotlin.Resource() {
	override fun typestring() ="subresource"
	  var default_ttl: Int? = null
  var min_ttl: Int? = null
  var smooth_streaming: Boolean? = null
...
class Cache_behavior(val allowed_methods : List<String>, val forwarded_values : List<Forwarded_values>, val viewer_protocol_policy : String, val target_origin_id : String, val cached_methods : List<String>, val path_pattern : String) :  com.typedpath.terraform2kotlin.Resource() {
	override fun typestring() ="subresource"
	  var lambda_function_association: List<Lambda_function_association>? = null
  var min_ttl: Int? = null
  var compress: Boolean? = null
