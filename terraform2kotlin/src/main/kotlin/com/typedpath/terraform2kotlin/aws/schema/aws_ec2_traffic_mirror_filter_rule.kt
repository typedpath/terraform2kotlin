...
class aws_ec2_traffic_mirror_filter_rule(val rule_action : Rule_action, val rule_number : Int, val destination_cidr_block : String, val source_cidr_block : String, val traffic_direction : Traffic_direction, val traffic_mirror_filter_id : String) :  com.typedpath.terraform2kotlin.Resource() {
