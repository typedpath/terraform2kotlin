...
class Http_header(val values : List<String>, val http_header_name : String) :  com.typedpath.terraform2kotlin.Resource() {
	override fun typestring() ="subresource"
...
class Authenticate_oidc(val token_endpoint : String, val user_info_endpoint : String, val client_secret : String, val issuer : String, val authorization_endpoint : String, val client_id : String) :  com.typedpath.terraform2kotlin.Resource() {
	override fun typestring() ="subresource"
	  var scope: String? = null
  var authentication_request_extra_params: Map<String, String>? = null
  var on_unauthenticated_request: On_unauthenticated_request? = null
