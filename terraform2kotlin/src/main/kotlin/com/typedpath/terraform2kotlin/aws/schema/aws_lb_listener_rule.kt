...
class Authenticate_oidc(val client_secret : String, val issuer : String, val client_id : String, val authorization_endpoint : String, val token_endpoint : String, val user_info_endpoint : String) :  com.typedpath.terraform2kotlin.Resource() {
	override fun typestring() ="subresource"
