...
class Authenticate_oidc(val client_id : String, val authorization_endpoint : String, val token_endpoint : String, val user_info_endpoint : String, val client_secret : String, val issuer : String) :  com.typedpath.terraform2kotlin.Resource() {
	override fun typestring() ="subresource"
	  var on_unauthenticated_request: On_unauthenticated_request? = null
  var scope: String? = null
  var session_cookie_name: String? = null
