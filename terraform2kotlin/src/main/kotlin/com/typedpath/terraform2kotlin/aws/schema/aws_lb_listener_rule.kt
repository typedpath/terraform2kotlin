...
class aws_lb_listener_rule(val condition : List<Condition>, val listener_arn : String, val action : List<Action>) :  com.typedpath.terraform2kotlin.Resource() {
...
class Authenticate_oidc(val client_id : String, val client_secret : String, val authorization_endpoint : String, val issuer : String, val token_endpoint : String, val user_info_endpoint : String) :  com.typedpath.terraform2kotlin.Resource() {
	override fun typestring() ="subresource"
	  var on_unauthenticated_request: On_unauthenticated_request? = null
  var scope: String? = null
  var session_cookie_name: String? = null
