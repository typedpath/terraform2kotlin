...
class aws_cloudwatch_metric_alarm(val alarm_name : String, val comparison_operator : String, val evaluation_periods : Int) :  com.typedpath.terraform2kotlin.Resource() {
