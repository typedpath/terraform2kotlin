...
class aws_appautoscaling_policy(val resource_id : String, val service_namespace : String, val scalable_dimension : String, val name : String) :  com.typedpath.terraform2kotlin.Resource() {
