...
class aws_batch_job_queue(val state : State, val compute_environments : List<String>, val name : String, val priority : Int) :  com.typedpath.terraform2kotlin.Resource() {
