...
class aws_api_gateway_integration(val rest_api_id : String, val http_method : Http_method, val resource_id : String, val type : Type) :  com.typedpath.terraform2kotlin.Resource() {
