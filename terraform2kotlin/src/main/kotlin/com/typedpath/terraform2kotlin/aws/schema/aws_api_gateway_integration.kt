...
class aws_api_gateway_integration(val http_method : Http_method, val type : Type, val rest_api_id : String, val resource_id : String) :  com.typedpath.terraform2kotlin.Resource() {
