...
class aws_api_gateway_integration(val rest_api_id : String, val resource_id : String, val type : Type, val http_method : Http_method) :  com.typedpath.terraform2kotlin.Resource() {
