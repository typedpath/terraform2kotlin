...
class aws_api_gateway_integration(val resource_id : String, val type : Type, val rest_api_id : String, val http_method : Http_method) :  com.typedpath.terraform2kotlin.Resource() {
